...
/* global $, window */
    ...
    var edad_a,peso_n,peso_actual,talla,id_visita,id_opcion = 0;
    var flag = false;
    var arr = [];
    var index,grafica_info, id_integrante, data_a = '';
    ...
    $('.peso_al_nacer').on('keyup', function(){
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            dataType: 'text',
            data: {id_integrante:id_integrante,id_visita:id_visita},
            beforeSend: function(){
    ...
    $('.modal_peso_m').on('click', function(){
        index = $('.modal_peso_m').index($(this))+1;
        grafica_info = $(this).attr('target');
        id_integrante = $('input[name="id_integrante_'+index+'"').val();
        id_visita = $('input[name="id_visita_'+index+'"').val();
        id_opcion = $('input[name="id_opcion_'+index+'"').val();
        data_a = [];
        ...
        if (typeof chart == 'undefined' && $('input[name="tb2_peso_al_nacer_'+index+'"]').val() == '') {
          ...
          if (edad_actual > 60) edad_actual = 60;
          if (peso_actual > 22) peso_actual = 22;
          if (peso_actual < 0) peso_actual = 0;
          if (peso_n > 22000) peso_n = 22000;
    ...
    $('.modal_talla_m').on('click', function(){
        ...
        index = $('.modal_talla_m').index($(this))+1;
        id_integrante = $('input[name="id_integrante_'+index+'"').val();
        id_visita = $('input[name="id_visita_'+index+'"').val();
        id_opcion = $('input[name="id_opcion_'+index+'"').val();
        data_a = [];
        ...
        if (edad_actual > 60) edad_actual = 60;
        if (talla_actual > 125) talla_actual = 125;
        if (talla_actual < 40) talla_actual = 40;

        jQuery.ajax({
            url: '/instituto/core/includes/datos_grafica_talla.php',
            type: 'POST',
            dataType: 'text',
            data: {id_integrante:id_integrante,id_visita:id_visita},
            beforeSend: function(){
      ...
      $('.peso_al_nacer_2').on('keyup', function(){
        $(this).parent().find('.grafica_info').slideDown('slow');
        $(this).parent().parent().find('.canvas_p').slideDown('slow');
        ...
        peso_n = peso_n/1000;
        jQuery.ajax({
            url: '/instituto/core/includes/datos_grafica_peso_2.php',
            type: 'POST',
            dataType: 'text',
            data: {id_integrante:id_integrante,id_visita:id_visita},
            beforeSend: function(){
    ...
    $('.modal_peso_m2').on('click', function(){
        index = $('.modal_peso_m2').index($(this))+1;
        grafica_info = $(this).attr('target');
        id_integrante = $('input[name="id_integrante_'+index+'"]').val();
        id_visita = $('input[name="id_visita_'+index+'"').val();
        id_opcion = $('input[name="id_opcion_'+index+'"').val();
        data_a = [];
        console.log('id_integrante: '+id_integrante+' '+index);
        console.log('id_integrante: '+id_opcion+' '+id_visita);
      
        if (typeof chart == 'undefined' && $('input[name="tb3_peso_al_nacer_'+index+'"]').val() == '') {
          console.debug('entro rico 1');
          ctx = document.getElementById('canvas_p'+index).getContext('2d');
          chart = new Chart(ctx, config);
        }
        else if(typeof chart == 'undefined' && $('input[name="tb3_peso_al_nacer_'+index+'"]').val() != ''){
          console.debug('entro rico 2');
          ctx = document.getElementById('canvas_p'+index).getContext('2d');
          chart = new Chart(ctx, config);
    ...
    $('.modal_talla_m2').on('click', function(){
        // console.debug($('button[target="modal_peso_m"]'));
        // console.debug($('.modal_peso_m'));
        index = $('.modal_talla_m2').index($(this))+1;
        id_integrante = $('input[name="id_integrante_'+index+'"').val();
        id_visita = $('input[name="id_visita_'+index+'"').val();
        id_opcion = $('input[name="id_opcion_'+index+'"').val();
        data_a = [];
        ...
        jQuery.ajax({
            url: '/instituto/core/includes/datos_grafica_talla_2.php',
            type: 'POST',
            dataType: 'text',
            data: {id_integrante:id_integrante,id_visita:id_visita},
            beforeSend: function(){
       ...
       $(".modal_peso .close,.modal_peso .acept,.modal_peso.modal").on('click', function(){
          console.log(chart);
          chart.destroy();
          delete chart;
       });

        $(".modal_peso_2 .close,.modal_peso_2 .acept,.modal_peso_2.modal").on('click', function(){
          chart.destroy();
          delete chart;
       });

       $(".modal_talla .close,.modal_talla .acept,.modal_talla.modal").on('click', function(){
          chart2.destroy();
          delete chart2;
       });

        $(".modal_talla_2 .close,.modal_talla_2 .acept,.modal_talla_2.modal").on('click', function(){
          chart2.destroy();
          delete chart2;
       });
