...
<body>
	<?php 
		...
		$id_visita = 1;
		$cont = 1;
		$sql = "SELECT * FROM integrantes JOIN de_1_a_5 USING(id_integrante) JOIN visitas USING(id_visita,id_familia) WHERE visitas.id_familia = '$id_familia' AND edad_anos >= 1 AND edad_anos < 5";
		$query = $bd->query($sql);
		...
		if ($query->num_rows == 0) {
	        ...
	        echo "<p>No Existen Registros de Niños de 1 a 5 Años en esta Familia</p>";
	        echo "<button type='button' class='button next block' onclick='window.location=\"niños_5_a_9.php\"'>Siguiente</button>";
	        echo "</div>";
		}
		else{ 
					...
					<table id="tb3_niños_1a5">
						...
						<tbody>
							...
							<tr>
								...
								<td><input class="tb3_edad" type="number" name="tb3_edad_<?php echo $cont?>" value="<?php echo $row->edad_meses_vis?>"></td>
								<?php 
								...
								<td><input class="tb3_peso" type="number" name="tb3_peso_<?php echo $cont?>" step=0.1  value="<?php echo $row->peso?>" min=1 max=100 required></td>
								<td><input class="tb3_talla" type="number" name="tb3_talla_<?php echo $cont?>" step=0.1  value="<?php echo $row->talla?>" min=1 max=200 required></td>
								<td><input class="tb3_imc" type="number" name="tb3_imc_<?php echo $cont?>" step=0.1  value="<?php echo $row->imc?>" min=1 max=100 required></td>
								<td>
									<div class="divgraf">
								...
								<td>
									<input class="tb3_desparasitado_si year_current_td" id="tb3_despara_a_<?php echo $cont?>" type="number" name="tb3_desparasitado_a_<?php echo $cont?>" value="<?php echo $row->desparasitado_a?>">
								</td>
								 <td>
				...
				<div class="table">
					<table id="tb3_observaciones" class="observaciones">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $cont_sig?></td>
								<td><input type="text" name="tb3_observaciones_<?php echo $cont?>" value="<?php echo $row->observaciones?>"></td>
							</tr>
							<?php
							$cont_v_actual++;
							$cont_sig++; 
	...
	<div class="nav_inf">
		<ul>
			...
			<li class="active" onclick="window.location='niños_1_a_5.php'"><label>1 a 5 Años..<div class="info_tb">Registro de Actividades Niños(as) 1 a 5 años</div></label></li>
