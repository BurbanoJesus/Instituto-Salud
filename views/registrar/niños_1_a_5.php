...
<body>
	<?php 
		...
		$cont = 1;
		$sql = "SELECT * FROM integrantes WHERE id_familia = '$id_familia' AND edad_anos >= 1 AND edad_anos < 5";
		$query = $bd->query($sql);
		$query_2 = $query; 
		...
		if ($query->num_rows == 0 or $query_s->num_rows > 0) {
			...
			header("location: /instituto/views/registrar/niños_5_a_9.php");
			return False;
		...
		?>
	<main>
		<form id="form5" action="/instituto/core/registro/s_niños_1_a_5.php" method="POST">
			<div class="divh1">
					...
					<table id="tb3_niños_1a5">
							...
							<tr>
								...
								<th colspan="2" class="table_info">
									...
									<div class="info">
										...
										<label>10</label><span class="otros_tb_info">Otro: <input type="text" name="tb3_otra_remision" value=""/></span>
									</div>
								</th>
						...
						<tbody>
							...
							<tr>
								...
								<td><input class="tb3_edad" type="number" name="tb3_edad_<?php echo $cont?>" value="<?php echo $row->edad_meses+$row->edad_anos*12?>"></td>
								<td><input id="tb3_control_crec_si_<?php echo $cont?>" type="radio"  name="tb3_control_crecimiento_<?php echo $cont?>" value="si"><label class="radio" for="tb3_control_crec_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_control_crec_no_<?php echo $cont?>" type="radio"  name="tb3_control_crecimiento_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_control_crec_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_lactancia_si_<?php echo $cont?>" type="radio"  name="tb3_lactancia_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_lactancia_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_lactancia_no_<?php echo $cont?>" type="radio"  name="tb3_lactancia_<?php echo $cont?>" value="no" checked>
								...
								<td>
									<input id="tb3_estado_n_<?php echo $cont?>" type="radio"  name="tb3_estado_nutricional_<?php echo $cont?>" value="normal" checked>
									<label class="radio" for="tb3_estado_n_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_estado_a_<?php echo $cont?>" type="radio"  name="tb3_estado_nutricional_<?php echo $cont?>" value="anormal">
									<label class="radio" for="tb3_estado_a_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_motri_g_n_<?php echo $cont?>" type="radio"  name="tb3_motricidad_gruesa_<?php echo $cont?>" value="normal" checked>
									<label class="radio" for="tb3_motri_g_n_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_motri_g_a_<?php echo $cont?>" type="radio"  name="tb3_motricidad_gruesa_<?php echo $cont?>" value="anormal">
									<label class="radio" for="tb3_motri_g_a_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_motri_f_n_<?php echo $cont?>" type="radio"  name="tb3_motricidad_fina_<?php echo $cont?>" value="normal" checked>
									<label class="radio" for="tb3_motri_f_n_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_motri_f_a_<?php echo $cont?>" type="radio"  name="tb3_motricidad_fina_<?php echo $cont?>" value="anormal">
									<label class="radio" for="tb3_motri_f_a_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_audi_n_<?php echo $cont?>" type="radio"  name="tb3_audicion_lenguaje_<?php echo $cont?>" value="normal" checked>
									<label class="radio" for="tb3_audi_n_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_audi_a_<?php echo $cont?>" type="radio"  name="tb3_audicion_lenguaje_<?php echo $cont?>" value="anormal">
									<label class="radio" for="tb3_audi_a_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_pers_n_<?php echo $cont?>" type="radio"  name="tb3_personal_social_<?php echo $cont?>" value="normal" checked>
									<label class="radio" for="tb3_pers_n_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_pers_a_<?php echo $cont?>" type="radio"  name="tb3_personal_social_<?php echo $cont?>" value="anormal">
									<label class="radio" for="tb3_pers_a_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input class="tb3_m_fisico" id="tb3_m_fisico_<?php echo $cont?>" type="checkbox" name="tb3_maltrato_fisico_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_m_fisico_<?php echo $cont?>" ></label>
								</td>
								 <td>
									<input class="tb3_m_psico" id="tb3_m_psico_<?php echo $cont?>" type="checkbox" name="tb3_maltrato_psicologico_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_m_psico_<?php echo $cont?>" ></label>
								</td>
								 <td>
									<input class="tb3_m_no" id="tb3_m_no_<?php echo $cont?>" type="radio"  name="tb3_maltrato_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_m_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_problema_v_si_<?php echo $cont?>" type="radio"  name="tb3_problema_visual_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_problema_v_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_problema_v_no_<?php echo $cont?>" type="radio"  name="tb3_problema_visual_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_problema_v_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_problema_a_si_<?php echo $cont?>" type="radio"  name="tb3_problema_auditivo_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_problema_a_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_problema_a_no_<?php echo $cont?>" type="radio"  name="tb3_problema_auditivo_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_problema_a_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_carnet_si_<?php echo $cont?>" type="radio"  name="tb3_carnet_<?php echo $cont?>" value="si" checked>
									<label class="radio" for="tb3_carnet_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_carnet_no_<?php echo $cont?>" type="radio"  name="tb3_carnet_<?php echo $cont?>" value="no">
									<label class="radio" for="tb3_carnet_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_bcg_<?php echo $cont?>" type="checkbox" name="tb3_bcg_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_bcg_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_p1_<?php echo $cont?>" type="checkbox" name="tb3_polio1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_p1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_p2_<?php echo $cont?>" type="checkbox" name="tb3_polio2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_p2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_p3_<?php echo $cont?>" type="checkbox" name="tb3_polio3_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_p3_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_pr1_<?php echo $cont?>" type="checkbox" name="tb3_polio_r1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_pr1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_pr2_<?php echo $cont?>" type="checkbox" name="tb3_polio_r2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_pr2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_dpt1_<?php echo $cont?>" type="checkbox" name="tb3_dpt1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_dpt1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_dpt2_<?php echo $cont?>" type="checkbox" name="tb3_dpt2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_dpt2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_dpt3_<?php echo $cont?>" type="checkbox" name="tb3_dpt3_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_dpt3_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_dpt_r1_<?php echo $cont?>" type="checkbox" name="tb3_dpt_r1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_dpt_r1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_dpt_r2_<?php echo $cont?>" type="checkbox" name="tb3_dpt_r2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_dpt_r2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hepa1_<?php echo $cont?>" type="checkbox" name="tb3_hepatitisb1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hepa1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hepa2_<?php echo $cont?>" type="checkbox" name="tb3_hepatitisb2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hepa2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hepa3_<?php echo $cont?>" type="checkbox" name="tb3_hepatitisb3_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hepa3_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hib1_<?php echo $cont?>" type="checkbox" name="tb3_hib1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hib1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hib2_<?php echo $cont?>" type="checkbox" name="tb3_hib2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hib2_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_hib3_<?php echo $cont?>" type="checkbox" name="tb3_hib3_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_hib3_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_srp1_<?php echo $cont?>" type="checkbox" name="tb3_srp1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_srp1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_srp_r1_<?php echo $cont?>" type="checkbox" name="tb3_srp_r1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_srp_r1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_influenza1_<?php echo $cont?>" type="checkbox" name="tb3_influenza1_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_influenza1_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_influenza2_<?php echo $cont?>" type="checkbox" name="tb3_influenza2_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_influenza2_<?php echo $cont?>" ></label>
								</td>
								 <td>
									<input id="tb3_fiebre_a_<?php echo $cont?>" type="checkbox" name="tb3_fiebre_amarilla_<?php echo $cont?>" value="si">
									<label class="check" for="tb3_fiebre_a_<?php echo $cont?>" ></label>
								</td>
								
								 <td>
									<input id="tb3_num_cep_<?php echo $cont?>" type="number" name="tb3_numero_cepilladas_<?php echo $cont?>" value="">
								</td>
								<td>
									<input class="consume_medicamento_si" id="tb3_consume_m_si_<?php echo $cont?>" type="radio"  name="tb3_consume_medica_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_consume_m_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input class="consume_medicamento_txt" id="tb3_consume_m_txt_<?php echo $cont?>" type="text" name="tb3_consume_medica_txt_<?php echo $cont?>" value="">
								</td>
								<td>
									<input class="consume_medicamento_no" id="tb3_consume_m_no_<?php echo $cont?>" type="radio"  name="tb3_consume_medica_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_consume_m_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input class="tb3_desparasitado_si" id="tb3_despara_d_<?php echo $cont?>" type="number" name="tb3_desparasitado_d_<?php echo $cont?>" value="" min=1 max=31>
								</td>
								<td>
									<input class="tb3_desparasitado_si" id="tb3_despara_m_<?php echo $cont?>" type="number" name="tb3_desparasitado_m_<?php echo $cont?>" value="" min=1 max=12>
								</td>
								<td>
									<input class="tb3_desparasitado_si year_current_td" id="tb3_despara_a_<?php echo $cont?>" type="number" name="tb3_desparasitado_a_<?php echo $cont?>" value="" min=1900 max=<?php echo date("Y");?> >
								</td>
								<td>
									<input class="tb3_desparasitado_no" id="tb3_despara_no_<?php echo $cont?>" type="radio"  name="tb3_desparasitado_no_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_despara_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_canalizado_si_<?php echo $cont?>" type="radio"  name="tb3_canalizado_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_canalizado_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_canalizado_no_<?php echo $cont?>" type="radio"  name="tb3_canalizado_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_canalizado_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input class="remitido" id="tb3_remitido_si_<?php echo $cont?>" type="number"  name="tb3_remitido_<?php echo $cont?>" value="" min=0 max=10>
								</td>
								<td>
									<input class="remitido_no" id="tb3_remitido_no_<?php echo $cont?>" type="radio"  name="tb3_remitido_no_<?php echo $cont?>" value="no" checked>
									<label class="radio" for="tb3_remitido_no_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_valorado_si_<?php echo $cont?>" type="radio"  name="tb3_valorado_<?php echo $cont?>" value="si">
									<label class="radio" for="tb3_valorado_si_<?php echo $cont?>" ></label>
								</td>
								<td>
									<input id="tb3_valorado_no_<?php echo $cont?>" type="radio"  name="tb3_valorado_<?php echo $cont?>" value="no" checked>
									...
									<input type="hidden" name="id_visita_<?php echo $cont?>" value="1">
				...
				<div class="modal_main">
					<div class="modal_content">
						...
						<div class="peso_nac">
							...
							<input class="peso_al_nacer_2" type="number" name="tb3_peso_al_nacer_<?php echo $cont?>" value="" min=1 max=15000>
