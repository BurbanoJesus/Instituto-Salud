...
<body>
	<main>
		...
		$cont = 1;
		$sql = "SELECT * FROM integrantes JOIN de_60_mas USING(id_integrante)  WHERE integrantes.id_familia = '$id_familia' AND edad_anos >= 60 AND id_visita = (SELECT MAX(id_visita)-1 FROM visitas WHERE id_familia = '$id_familia')";
		$query = $bd->query($sql);
		$query_2 = $query; 
		...
		?>
		<form id="form8" action="/instituto/core/registro_sig/s_adultos_60_mas.php" method="POST">
			<div class="divh1">
