...
<body>
	<main>
		...
		$cont = 1;
		$sql = "SELECT * FROM integrantes JOIN gestacion USING(id_integrante)  WHERE integrantes.id_familia = '$id_familia' AND sexo = 'F' AND id_visita = (SELECT MAX(id_visita)-1 FROM visitas WHERE id_familia = '$id_familia')";
		$query = $bd->query($sql);
		$query_2 = $query; 
		...
		?>
		<form id="form9" action="/instituto/core/registro_sig/s_gestacion_parto.php" method="POST">
			<div class="divh1">
