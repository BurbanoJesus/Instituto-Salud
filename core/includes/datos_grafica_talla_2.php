<?php 
	...
	if ($_POST['id_integrante'] !== '') {
		...
		$sql = "SELECT de_1_a_5.edad_meses_vis,talla,id_visita FROM de_1_a_5 JOIN integrantes USING(id_integrante) WHERE id_familia = '$id_familia' AND id_visita <= '$id_visita' AND integrantes.id_integrante = '$id_integrante' ORDER BY id_visita";
		$query = $bd->query($sql);
		// echo $sql;
		// echo '<br>';
		// echo '<br>';
