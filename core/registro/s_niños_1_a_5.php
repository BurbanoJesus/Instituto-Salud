<?php 
	...
	while (isset($_POST['tb3_nombres_'.$cont.''])) {
		...
		$sql = "INSERT into de_1_a_5 values(null,$tb3_edad,'$tb3_control_crecimiento','$tb3_lactancia',$tb3_peso,$tb3_talla,$tb3_imc,'$tb3_peso_al_nacer','$tb3_estado_nutricional','$tb3_motricidad_gruesa','$tb3_motricidad_fina','$tb3_audicion_lenguaje','$tb3_personal_social','$tb3_maltrato_fisico','$tb3_maltrato_psicologico','$tb3_problema_visual','$tb3_problema_auditivo','$tb3_carnet','$tb3_bcg','$tb3_polio1','$tb3_polio2','$tb3_polio3','$tb3_polio_r1','$tb3_polio_r2','$tb3_dpt1','$tb3_dpt2','$tb3_dpt3','$tb3_dpt_r1','$tb3_dpt_r2','$tb3_hepatitisb1','$tb3_hepatitisb2','$tb3_hepatitisb3','$tb3_hib1','$tb3_hib2','$tb3_hib3','$tb3_srp1','$tb3_srp_r1','$tb3_influenza1','$tb3_influenza2','$tb3_fiebre_amarilla','$tb3_numero_cepilladas','$tb3_desparasitado_no','$tb3_desparasitado_d','$tb3_desparasitado_m','$tb3_desparasitado_a','$tb3_consume_medica','$tb3_consume_medica_txt','$tb3_canalizado','$tb3_remitido','$tb3_otra_remision','$tb3_valorado','$tb3_observaciones','$id_integrante',$id_visita)";
