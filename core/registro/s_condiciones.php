<?php 
	...
	$arr_elementos_2= ['Elementos','Vela','Lampara Petroleo','Energia Solar','Energia_electrica','Interconexion','Planta','Otro'];
	$arr_elementos_3= ['Elementos','Acueducto','Agua Lluvia','Rio quebrada','Pozo','Chorro','Aljibe','Comprada','Otro'];
	$arr_elementos_4= ['Elementos','Caneca con Tapa','Caneca sin Tapa','Balde y/o Tarro','Carton','Bolsa Plastica','Caja Madera','Otro','Botadero Publico','Rio Quebrada','Solar','Caja Madera f','Usada Abono','Otro f'];
